...
# Из трех вариантов больше всего памяти занимают переменные в очереди. Размер счетчика из collections оказался равным двум листам,
# но код с помощью Counter гораздо проще остальных вариантов. Также заодно сравнил словари из и collections обычный словарь.
# Самым "легким" оказался обычный словарь, самым "тяжелым" - упорядоченный. Остальные варианты оказались ненамного объемнее
# обычного словаря.
